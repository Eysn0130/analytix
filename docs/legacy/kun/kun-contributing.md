...
> `docs/CONTRIBUTING.zh-CN.md`, and current analytix architecture rules live in
...
- `docs/legacy/kun/kun-architecture.md` 描述"为什么这样设计";
- `kun/README.md` 描述 CLI / env / data dir;
- `docs/legacy/kun/kun-contributing.md`(本文)描述"如何贡献";
...
- [ ] 不修改任何 `docs/legacy/kun/kun-architecture.md` 描述以外的文件
      来"绕过" typecheck
...
- [ ] 新增 SSE 事件时,给 `docs/legacy/kun/kun-architecture.md` 加一行
- [ ] 在 `docs/legacy/kun/kun-architecture.md` 的 borrow map 中(如未来
