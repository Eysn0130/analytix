> Historical legacy-kun runtime note. This document is retained only for
> migration background. Current contribution rules live in
> `docs/CONTRIBUTING.md`, and current analytix architecture rules live in
> `docs/analytix/specs/01-06`.
...
- `docs/legacy/kun/kun-architecture.md` describes "why it is designed this way";
- `kun/README.md` description CLI/env/data dir;
- `docs/legacy/kun/kun-contributing.md` (this article) describes "how to contribute";
...
- [ ] Do not modify any files other than those described in `docs/legacy/kun/kun-architecture.md`
      to "bypass" typecheck
...
- [ ] When adding a new SSE event, add a line to `docs/legacy/kun/kun-architecture.md`- [ ] in the borrow map of `docs/legacy/kun/kun-architecture.md` (as in the future
