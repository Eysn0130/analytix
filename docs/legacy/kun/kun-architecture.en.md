> Historical legacy-kun architecture note. This document is retained only for
> migration background. Current analytix architecture, settings, CLI, bridge,
> packaging, and acceptance rules live in `docs/analytix/specs/01-06`,
