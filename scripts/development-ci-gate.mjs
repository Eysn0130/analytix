...
export const requiredDevelopmentJobs = [
  'windows-credential-backend', 'source-baseline', 'application-tests', 'macos-integration', 'filesystem-contracts', 'restart-contracts', 'runtime-shards', 'runtime-platform', 'go-tests', 'backend-tests', 'rust-tests'
]
