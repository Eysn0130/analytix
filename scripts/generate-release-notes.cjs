#!/usr/bin/env node
/**
 * Build local release notes from conventional commits since the previous tag.
 *
 * Usage:
 *   node scripts/generate-release-notes.cjs [sinceTag]
 *   node scripts/generate-release-notes.cjs v0.1.0.8
 *
 * If sinceTag is omitted, uses the newest local v* tag.
 */
