...
# =============================================================================
# release.sh - macOS local release wrapper
#
# Default behavior builds macOS artifacts, writes local release metadata, and
# creates a local version tag. Windows artifacts are built separately on Windows.
