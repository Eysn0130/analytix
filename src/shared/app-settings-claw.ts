...
import {
  ...
  normalizeClawImPlatformAccount,
  ...
  return {
    ...
    channels: rawChannels
      .map((channel, index): ClawImChannelV1 => {
          ...
          const id = typeof raw.id === 'string' && raw.id.trim() ? raw.id.trim() : `im-${index + 1}`
          ...
          return {
            ...
            platformAccount: normalizeClawImPlatformAccount(raw.platformAccount, raw.platformCredential, id),
