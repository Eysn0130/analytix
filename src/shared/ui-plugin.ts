...
/**
 * 与内置模式、DOM 属性值保留字互斥。
 * 注意:'mascot' 不在保留字里 —— 旧版兼容形象包曾使用这个 id,
 * 读取历史配置时仍需识别它。
 */
const UI_PLUGIN_RESERVED_IDS = new Set(['default', 'analytix', 'on', 'off', 'none'])

/** 旧版兼容形象包 id。 */
export const UI_PLUGIN_BUNDLED_MASCOT_ID = 'mascot'
