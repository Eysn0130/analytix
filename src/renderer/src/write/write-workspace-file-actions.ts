...
export function createWriteFileActions({
  ...
  return {
    ...
    loadDirectory: async (workspaceRoot, path) => {
      ...
      let result: Awaited<ReturnType<typeof window.analytix.files.listDirectory>>
      try {
    ...
    createFile: async (workspaceRoot, path, content = '') => {
      let result: Awaited<ReturnType<typeof window.analytix.files.createFile>>
      try {
        result = await window.analytix.files.createFile({ workspaceRoot, path, content })
      } catch (error) {
    ...
    createDirectory: async (workspaceRoot, path) => {
      let result: Awaited<ReturnType<typeof window.analytix.files.createDirectory>>
      try {
        result = await window.analytix.files.createDirectory({ workspaceRoot, path })
      } catch (error) {
        set({ fileError: formatActionError(error) })
        return null
      }
    ...
    renameEntry: async (workspaceRoot, path, newName) => {
      ...
      try {
        result = await window.analytix.files.renameEntry({ workspaceRoot, path, newName })
      } catch (error) {
        set({ fileError: formatActionError(error) })
        return null
      }
    ...
    deleteEntry: async (workspaceRoot, path) => {
      ...
      try {
        result = await window.analytix.files.deleteEntry({ workspaceRoot, path })
      } catch (error) {
        set({ fileError: formatActionError(error) })
        return false
      }
