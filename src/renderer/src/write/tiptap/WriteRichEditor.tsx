...
import {
  ...
  WriteTextAlignMarkdown
} from './text-align-markdown'
...
export type WriteRichEditorHandle = {
  ...
  /** Set paragraph alignment on the selected paragraph/heading blocks. */
...
function applyRichTextAlign(editor: Editor, align: WriteTextAlign): boolean {
  ...
  state.doc.nodesBetween(from, to, (node, pos) => {
    ...
    const current = node.attrs.textAlign ?? null
