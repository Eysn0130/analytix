...
export type LoadedAnalytixDiagnostics = {
...
export async function loadAnalytixDiagnostics(
  provider: DiagnosticsProvider,
  options: { workspace?: string } = {}
): Promise<LoadedAnalytixDiagnostics> {
  ...
  const loaded: LoadedAnalytixDiagnostics = {
    runtimeInfo: null,
