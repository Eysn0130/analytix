...
/** Design intent captured on a requirement and injected into generation prompts. */
...
export type SddDraft = {
  ...
  createdAt: string
  updatedAt: string
  /** Optional design intent surfaced to plan/prototype prompts. */
...
function normalizeDraft(raw: unknown, fallbackId = ''): SddDraft | null {
  ...
  // Pre-unit-layout registry entries (.analytixsdd/draft/...) are retired here in
