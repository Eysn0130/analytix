...
export function WorkspaceProjectPicker({ currentWorkspaceRoot }: Props): ReactElement {
  ...
  return (
    <div ref={wrapRef} className="ds-workspace-project-picker ds-no-drag relative min-w-0">
      ...
      {open ? (
        <div className="absolute bottom-[calc(100%+8px)] left-0 z-50 w-[min(360px,calc(100vw-48px))] overflow-hidden rounded-xl border border-ds-border bg-ds-elevated shadow-[var(--ax-shadow-popover)] backdrop-blur-xl">
          {showSearch ? (
