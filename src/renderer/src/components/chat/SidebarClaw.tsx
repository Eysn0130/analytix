...
export function ClawProviderLogo({
  ...
  if (provider === 'telegram') {
    return (
      ...
      >
        <path
          d="M21.6 4.2 18.8 19c-.2 1.1-.9 1.3-1.8.8l-4.9-3.6-2.4 2.3c-.3.3-.5.5-1 .5l.4-5 9.1-8.2c.4-.4-.1-.6-.6-.2L6.2 12.8 1.4 11.3c-1-.3-1-1 .2-1.5L20.3 2.6c.9-.3 1.6.2 1.3 1.6Z"
          fill="#2AABEE"
        />
        <path d="M9.1 14 8.8 19c.5 0 .7-.2 1-.5l2.4-2.3-3.1-2.2Z" fill="#168ACB" />
      </svg>
    )
  }
  if (provider === 'weixin') {
