...
type Props = {
  ...
  /** Capacity warning threshold, as a share of the window. */
...
export function ContextCapacityPopover({ capacity, thresholdRatio = 0.9 }: Props): ReactElement {
  ...
  return (
    <div
      className="ds-context-capacity w-[300px] rounded-2xl border border-ds-border-muted bg-ds-card p-3.5 text-ds-ink shadow-[var(--ax-shadow-popover)]"
      role="dialog"
