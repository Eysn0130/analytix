...
export function ChatFileTreePanel({
  ...
  const loadDirectory = useCallback((path: string): void => {
    if (!root || typeof window.analytix?.files?.listDirectory !== 'function') return
      ...
      {fill ? (
        <div className="ds-right-panel-topbar border-b border-ds-border-muted">
          <div className="ds-right-panel-title-group">
            <FolderSearch className="ds-right-panel-title-icon" strokeWidth={1.8} />
            <span className="ds-right-panel-title" title={rootName || t('fileTreeTitle')}>
              {rootName || t('fileTreeTitle')}
            </span>
          ...
          <div className="ds-right-panel-actions">
            <SidebarIconButton
              ...
              onClick={refresh}
              className="ds-right-panel-icon-button"
            >
        ...
        >
          ...
          >
            ...
            <span className="min-w-0 truncate">
              {window.analytix?.app?.platform === 'darwin'
