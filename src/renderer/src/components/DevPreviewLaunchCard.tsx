...
export function DevPreviewLaunchCard({
  ...
  return (
    <div className="flex min-h-[72px] w-full items-center gap-3 rounded-[18px] border border-ds-border-muted bg-white/[0.78] px-4 py-3 shadow-[var(--ax-shadow-floating)] backdrop-blur-xl dark:border-white/[0.09] dark:bg-white/[0.045]">
