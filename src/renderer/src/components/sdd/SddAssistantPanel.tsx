...
export function SddAssistantPanel({
  ...
  const hasTimeline = blocks.length > 0 || busy || hasLiveStream
      ...
      <div className="sdd-assistant-header shrink-0 border-b border-ds-border-muted bg-white/92 dark:bg-ds-card">
        <div className="ds-right-panel-topbar">
          ...
          <div className="ds-right-panel-title-group">
            <Sparkles className="ds-right-panel-title-icon sdd-assistant-sparkle" strokeWidth={1.8} />
            <span className="ds-right-panel-title">
              {t('sddAssistant')}
            </span>
            <span className="ds-right-panel-subtitle" title={draft.relativePath}>
              {draft.relativePath}
            </span>
          </div>
