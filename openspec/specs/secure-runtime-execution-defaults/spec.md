# secure-runtime-execution-defaults Specification

## Purpose
Define conservative interactive and unattended execution defaults, narrow
legacy migration, and matching Go enforcement for shell and filesystem
boundaries.
