# Case Claim Publication Gate Specification

## Purpose
Define normalized longitudinal case claims, exact evidence support,
deterministic mixed-result gating, and ordinary/controlled rendering.
