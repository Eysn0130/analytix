# context-epoch Specification

## Purpose
Define thread-scoped context source registration, bounded provider snapshots,
stable-prefix evidence and safe compaction/restart recovery.
