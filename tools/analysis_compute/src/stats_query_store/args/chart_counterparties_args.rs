...
#[derive(Debug)]
pub(crate) struct QueryChartCounterpartiesArgs {
...
pub(crate) fn parse_query_chart_counterparties_args(
    iter: impl Iterator<Item = String>,
) -> Result<QueryChartCounterpartiesArgs> {
    ...
    Ok(QueryChartCounterpartiesArgs {
        case_id,
        db_path,
        selected_keys,
        date_start,
