...
#[derive(Debug)]
pub(crate) struct QueryChartDistributionArgs {
...
pub(crate) fn parse_query_chart_distribution_args(
    iter: impl Iterator<Item = String>,
) -> Result<QueryChartDistributionArgs> {
