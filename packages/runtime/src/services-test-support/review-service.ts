...
import { buildReadOnlyBuiltinLocalTools } from '../tool-test-support/tool/builtin-tools.js'
import { LocalToolHost } from '../tool-test-support/tool/local-tool-host.js'
...
import type { ContextCompactionConfig, ModelConfig } from '../shared/model-context-profile.js'
import { modelCapabilitiesForModel } from '../shared/model-context-profile.js'
...
import { resolveReviewTargetPrompt } from '../shared/review-target.js'
import { parseReviewOutput, renderReviewOutput } from '../shared/review-output.js'

const ANALYTIX_REVIEW_PROMPT = [
  ...
  private async runIsolatedReviewer(input: {
    ...
    const loop = new AgentLoop({
      ...
      prefix: createImmutablePrefix({
        systemPrompt: ANALYTIX_REVIEW_PROMPT,
      ...
      ...(this.deps.runtime?.stepLimits ? { stepLimits: this.deps.runtime.stepLimits } : {}),
