import type { ModelHistoryItem, ModelRequest, ModelToolSpec } from '../ports/model-client.js'
import type { RequestHistoryHygieneOptions } from '../shared/request-history-hygiene.js'
...
const PROTECTED_SEGMENT_PREFIX = '__ANALYTIX_PROTECTED_SEGMENT_'
...
export function compactHistoryItem(item: ModelHistoryItem): ModelHistoryItem {
  switch (item.kind) {
    case 'tool_call': {
