/**
 * Analytix-side mirror of the shared GUI plan contract from
 * Analytix's `src/shared/gui-plan.ts`.
 *
 * The renderer and the Analytix package live in the same repo but
 * TypeScript's `rootDir` constraint prevents Analytix from
