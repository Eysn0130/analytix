...
const GENERATED_SPEECH_DIR = '.analytix-audio'
const GENERATED_MUSIC_DIR = '.analytix-music'
const GENERATED_VIDEO_DIR = '.analytix-videos'
...
export function buildSpeechGenToolProviders(
  config: AnalytixCapabilitiesConfig['speechGen'] | undefined,
...
export function buildMusicGenToolProviders(
  config: AnalytixCapabilitiesConfig['musicGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
...
export function buildVideoGenToolProviders(
  config: AnalytixCapabilitiesConfig['videoGen'] | undefined,
  options: MediaGenToolProviderOptions = {}
