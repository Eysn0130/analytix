import { AgentLoop, type AgentLoopOptions } from '../src/loop-test-support/agent-loop.js'
...
import { LocalToolHost, defaultLocalTools, type LocalTool } from '../src/tool-test-support/tool/local-tool-host.js'
...
import type { TokenEconomyConfig } from '../src/shared/token-economy.js'
import type { ToolStormBreakerOptions } from '../src/shared/tool-storm-breaker.js'
import type { ContextCompactionConfig } from '../src/shared/model-context-profile.js'
...
export function makeHarness(
  ...
  options: {
    ...
    runtimeEnvironment?: AgentLoopOptions['runtimeEnvironment']
    modelCapabilities?: (model: string) => ModelCapabilityMetadata
    tokenEconomy?: TokenEconomyConfig
    contextCompaction?: ContextCompactionConfig
    stepLimits?: AgentLoopOptions['stepLimits']
    toolStorm?: ToolStormBreakerOptions & { enabled?: boolean }
    goalResume?: AgentLoopOptions['goalResume']
    nowIso?: () => string
    nowMs?: () => number
    toolArgumentRepair?: {
