...
import { repairDispatchToolArguments } from '../src/shared/tool-call-repair.js'
...
describe('tool call dispatch repair', () => {
  ...
  it('truncates very large non-file-change strings without touching file edits', () => {
    ...
    expect(String(repaired.arguments.transcript)).toContain('[truncated by Analytix tool argument repair]')
