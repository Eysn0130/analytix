...
func semanticJournalV3MigrationCode() string {
	return "semantic_journal_v3_windows_full_file_id_required"
}

func semanticPlanningV1MigrationCode() string {
	return "semantic_planning_v1_windows_full_file_id_required"
}

func semanticRetirementV1MigrationCode() string {
	return "semantic_retirement_v1_windows_full_file_id_required"
}
